...
model = densenet.DenseNet(growthRate=32, depth=190, reduction=0.5,
...
train_dir = '../train_data_new_new.npy'
validation_dir = '../validation_data_new_new.npy'
...
model_save_path = './checkpoint_densenet190'
